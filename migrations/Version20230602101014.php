 ...
 */
final class Version20230602101014 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__book AS SELECT id, title, author, isbn, released_at, plot, cover FROM book');
        ...
        , plot CLOB NOT NULL, cover VARCHAR(255) NOT NULL, CONSTRAINT FK_CBE5A331B03A8386 FOREIGN KEY (created_by_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO book (id, title, author, isbn, released_at, plot, cover) SELECT id, title, author, isbn, released_at, plot, cover FROM __temp__book');
